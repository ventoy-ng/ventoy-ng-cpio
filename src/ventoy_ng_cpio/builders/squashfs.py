...
@dataclass
class SquashfsBuilder(BaseBuilder):
    NAME = "squashfs"

    def __post_init__(self):
        self.makefile = Path("Makefile")
        self.bin_name = "unsquashfs"
        self.targets = [self.bin_name]
    ...
    def build(self):
        ...
        if make.run_if_needed(self.targets).is_up_to_date():
            return
        self.install()
